...
<head>
	...
	<link rel="stylesheet" href="<?php bloginfo('template_directory'); ?>/styles/main.css?v=1"> 
	<link rel="stylesheet" href="<?php bloginfo('template_directory'); ?>/styles/css3.css?v=1">
